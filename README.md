...
- extraction/fiches/arbitrage : `qwen3:14b`
- embeddings : `bge-m3`
...
`20_extract` et `40_enrich` demandent Ollama, mais la base peut etre chargee
depuis des artefacts `data/work/` deja produits ou generes par test.
